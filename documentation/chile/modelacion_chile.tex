...
\PY{n}{df} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}  \PY{c+c1}{\PYZsh{} Lectura de datos}
    \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{../archive/BBDD Población Chile (1b).xlsx \PYZhy{} Tabla ajustada población .csv}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
...
\PY{n}{x\PYZus{}E}\PY{o}{=}\PY{n}{sm}\PY{o}{.}\PY{n}{add\PYZus{}constant}\PY{p}{(}\PY{n}{x\PYZus{}E}\PY{p}{,}\PY{n}{prepend}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
...
\PY{k}{def}\PY{+w}{ }\PY{n+nf}{sistema\PYZus{}edos}\PY{p}{(}\PY{n}{t}\PY{p}{,} \PY{n}{y}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{c2} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mf}{0.0411}  \PY{c+c1}{\PYZsh{} tasa de mortalidad jóvenes}
    \PY{n}{const1} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mf}{2.929e+05}
    ...
    \PY{c+c1}{\PYZsh{}const2= 1.442e+06}
    \PY{n}{ta}\PY{o}{=}\PY{l+m+mf}{0.0207} \PY{c+c1}{\PYZsh{} transicion adultos}
    \PY{n}{c4} \PY{o}{=} \PY{l+m+mf}{0.0107}  \PY{c+c1}{\PYZsh{} tasa de mortalidad mayores}
    \PY{n}{const3}\PY{o}{=}\PY{o}{\PYZhy{}}\PY{l+m+mf}{2.048e+05}

    \PY{c+c1}{\PYZsh{} ECUACIONES}
    \PY{n}{dyJ} \PY{o}{=} \PY{n}{c1}\PY{o}{*}\PY{n}{at}\PY{o}{\PYZhy{}}\PY{n}{c2}\PY{o}{*}\PY{n}{jt}\PY{o}{+}\PY{n}{const1}
    \PY{n}{dyA} \PY{o}{=} \PY{n}{tj}\PY{o}{*}\PY{n}{jt}\PY{o}{\PYZhy{}}\PY{n}{c3}\PY{o}{*}\PY{n}{at}\PY{c+c1}{\PYZsh{}+const2}
    \PY{n}{dyE} \PY{o}{=} \PY{n}{ta}\PY{o}{*}\PY{n}{at}\PY{o}{\PYZhy{}}\PY{n}{c4}\PY{o}{*}\PY{n}{et}\PY{o}{+}\PY{n}{const3}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} hacer la grafica de los datos reales}
\PY{n}{fig}\PY{p}{,}\PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{12}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{)}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{df}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Población total de adultos (15\PYZhy{}64)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}\PY{n}{linewidth}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Poblacion de adultos}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{df}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Población total de jovenes (0\PYZhy{}14)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}\PY{n}{linewidth}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Poblacion de jovenes}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{ax}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{df}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Poblacion total mayores (65+ años)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}\PY{n}{linewidth}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Poblacion de adultos mayores}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{modelacion_chile_files/modelacion_chile_3_1.png}
    \end{center}
    { \hspace*{\fill} \\}
